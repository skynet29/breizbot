...
},{"base64-js":1,"buffer":11,"ieee754":5}],3:[function(require,module,exports){
...
},{"base64-js":1,"buffer":11,"ieee754":5,"isarray":6}],5:[function(require,module,exports){
...
(function () {
  ...
  var InvalidAccessTokenException = 'com.amazon.alexahttpproxy.exceptions.InvalidAccessTokenException';

  function blobToAudioBuffer(blob) {
    return $$.media.decodeAudioData(blob).then(function (buffer) {
  ...
  function sendAudioBuffer(accessToken, audioBuffer) {
    return new Promise(function (resolve, reject) {
      ...
      fd.append('audio', new Blob([new DataView(audioBuffer)], {
      ...
      xhr.onload = function (event) {
        ...
        if (xhr.status === 200) {
          var parsedMessage = httpMessageParser(buffer); //console.log('parsedMessage', parsedMessage)
    ...
    directives.forEach(function (directive) {
      if (directive.namespace === 'SpeechSynthesizer') {
        if (directive.name === 'speak') {
          ...
          var audio = findAudioFromContentId(audioMap, contentId);
  ...
  function sendAudio(accessToken, blob) {
    return blobToAudioBuffer(blob).then(function (audioBuffer) {
      return sendAudioBuffer(accessToken, audioBuffer);
    });
  }

  function promptUserLogin(cnxId) {
    var clientId = 'amzn1.application-oa2-client.0362e10e33584617919120e592423223';
    var productID = 'test_device';
    var deviceSerialNumber = 123;
    var redirectUri = "https://".concat(window.location.host, "/alexa/authresponse");
    var scope = 'alexa:all';
    var scopeData = {
      'alexa:all': {
        productID: productID,
    ...
    var authUrl = $$.url.getUrlParams('https://www.amazon.com/ap/oa', {
      client_id: clientId,
      scope: scope,
  ...
  module.exports = {
    sendAudio: sendAudio,
    decodeDirectives: decodeDirectives,
    promptUserLogin: promptUserLogin,
    InvalidAccessTokenException: InvalidAccessTokenException
  };
})();

},{"./util":8,"buffer/":2,"http-message-parser":3}],8:[function(require,module,exports){
"use strict";
...
(function () {
  ...
  var avs = require('./lib/avs'); //@ts-check
  ...
  $$.control.registerControl('rootPage', {
     ...
     */
    init: function init(elt, broker, appData) {
      var cnxId;
      var mediaRecorder = null;
      var chunks = [];
      var audioPlayer = new Audio();

      var _appData$getData = appData.getData(),
          accessToken = _appData$getData.accessToken; //console.log('accessToken', accessToken)
      ...
      broker.on('ready', function (msg) {
        console.log('msg', msg);
        cnxId = msg.clientId;
      });
      broker.onTopic('breizbot.alexa.auth', function (msg) {
        console.log('msg', msg);
        var access_token = msg.data.access_token;
      ...
      navigator.mediaDevices.getUserMedia({
        ...
        mediaRecorder.onstop = function (e) {
          ...
          chunks = [];
          avs.sendAudio(accessToken, blob).then(function (resp) {
...
},{"./lib/avs":7}],10:[function(require,module,exports){
'use strict'
...
},{"base64-js":10,"buffer":11,"dup":2,"ieee754":12}],12:[function(require,module,exports){
